      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Seguimiento de tus solicitudes</p>
          </div>
          <button
        ...
        <div className="mb-6">
          <select
            ...
            className="px-4 py-2 border border-gray-300 rounded-lg text-gray-900 text-sm bg-white"
          >
        ...
        {filteredTickets.length === 0 ? (
          <div className="bg-white rounded-2xl shadow-lg p-12 text-center">
            ...
            <p className="text-gray-500 font-medium">No tienes tickets</p>
            <p className="text-gray-400 text-sm mt-1">Crea tu primer ticket para reportar un problema</p>
            <button
              onClick={() => router.push('/dashboard/tickets/new')}
                  ...
                  <div className="border-t border-gray-100 pt-4">
                    {ticket.assigned_to ? (
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          <p className="text-sm font-medium text-gray-900">{ticket.assigned_to.name}</p>
                      ...
                      <p className="text-sm text-gray-400 italic">Sin técnico asignado</p>
                    )}
                  </div>
                </div>
              );
